...
<section class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 px-4">
  <div class="w-full max-w-md bg-white/95 backdrop-blur rounded-2xl shadow-2xl p-8 animate-fade-in">

    <!-- Logo / Título -->
    <div class="text-center mb-8">
      <div class="mx-auto w-16 h-16 flex items-center justify-center rounded-full bg-blue-100 mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
          <path d="M10 2a6 6 0 00-6 6v2a6 6 0 1012 0V8a6 6 0 00-6-6z" />
          <path d="M4 12a6 6 0 0012 0" />
        </svg>
      </div>
      <h1 class="text-2xl font-extrabold text-slate-800">Painel do Gestor</h1>
      <p class="text-slate-500 text-sm">Acesse sua conta para gerenciar alunos e boletins</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-5">
      ...
      <label class="block">
        ...
        <div class="mt-1 flex items-center border rounded-lg bg-slate-50 focus-within:ring-2 focus-within:ring-blue-500">
      ...
      <button class="w-full py-2.5 rounded-lg bg-blue-600 text-white font-semibold shadow hover:bg-blue-700 transition">
        Entrar
      </button>
    </form>
    ...
    <div class="text-center mt-8 text-xs text-slate-500">
      Desenvolvido por <span class="font-semibold text-blue-600">Bruno</span> &amp; <span class="font-semibold text-blue-600">Grêmio Areté - CEEP</span>
    </div>
  </div>
</section>
