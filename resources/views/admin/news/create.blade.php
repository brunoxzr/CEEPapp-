        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="title" required
                       ...
                       placeholder="Ex: CEEP Assaí realiza feira tecnológica">
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 mt-2">
                    Imagem usada em listagens e cards. Proporção 16:9 recomendada.
                </p>
            </div>
            ...
            <div>
                ...
                <input type="file" name="hero" accept="image/*"
                       class="w-full rounded-lg border-2 border-slate-300 bg-white text-slate-900 px-4 py-3 focus:ring-2 focus:ring-red-500 focus:border-red-500 transition">
                <p class="text-xs text-slate-500 mt-2">
                    Imagem grande no topo da notícia (estilo G1). Se não informar, usa a capa.
                </p>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    const quill = new Quill('#editor', {
        ...
        placeholder: 'Escreva sua notícia aqui. Use a barra de ferramentas para formatar o texto, adicionar imagens, links e muito mais...'
    });
